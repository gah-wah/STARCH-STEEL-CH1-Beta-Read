document.addEventListener('DOMContentLoaded', () => {
    ...
    if (charTrigger && charDropdown && charContainer) {
        ...
        // Load saved selection from localStorage on load, or pick random default between Wiggle, jagle, Carrotjak, Broco Loco, Growby Fun, and Nadica Monika
    ...
    const openBioModal = (charId) => {
        ...
        const showModal = (data) => {
            ...
            const dateHTML = charData.date ? `<div class="modal-bio-date">Joined ${charData.date}</div>` : '';
